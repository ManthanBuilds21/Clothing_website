    ...
    <div className="page-shell pb-8">
      ...
      >
        <div className="grid gap-8 xl:grid-cols-[1.05fr_0.95fr] xl:items-end">
          <div>
            <p className="eyebrow text-white/45">About MANTHAN</p>
      ...
      <div className="section-frame mt-10 grid gap-6 xl:grid-cols-[0.94fr_1.06fr]">
        <Reveal className="campaign-surface bg-[var(--beige)] p-6 sm:p-8">
          <div className="ghost-label ghost-outline text-black/16">Mission</div>
          <p className="mt-8 text-[1.35rem] leading-8 text-black/74 sm:text-[1.55rem] sm:leading-9">
      ...
      <Reveal className="section-frame mt-10 campaign-surface bg-[var(--pink)] px-6 py-10 text-white sm:px-8 sm:py-12">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="eyebrow text-white/55">Join the world</p>
          ...
          <Link
            to="/collections"
            className="inline-flex items-center gap-2 rounded-full border border-white/35 bg-white/14 px-6 py-4 text-xs font-semibold uppercase tracking-[0.24em] text-white backdrop-blur"
          >
            Shop now
