      ...
      <div className="section-frame campaign-surface bg-black px-6 py-10 text-white sm:px-10 sm:py-12">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="eyebrow text-white/48">MANTHAN Clothing</p>
            <h2 className="mt-4 text-[3rem] leading-[0.9] sm:text-[4.5rem] lg:text-[6.2rem]">
              Wear the future with a sharper edge.
            </h2>
          </div>
          <div className="grid gap-3 text-sm uppercase tracking-[0.22em] text-white/65">
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/12 pt-6 text-xs uppercase tracking-[0.22em] text-white/45 sm:flex-row sm:items-center sm:justify-between">
