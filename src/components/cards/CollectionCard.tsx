    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-between">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="eyebrow text-white/55">{collection.category}</p>
          ...
          <Link
            to="/collections"
            className="rounded-full border border-white/35 bg-white/14 p-3 text-white backdrop-blur transition-transform duration-300 group-hover:translate-x-1"
        ...
        <div className="glass-panel relative z-10 max-w-xl p-5 text-black">
          <p className="text-sm leading-7 text-black/68">{collection.description}</p>
          <p className="mt-4 text-xs font-semibold uppercase tracking-[0.24em] text-black/55">
            {collection.tagline}
          </p>
        </div>
      </div>
